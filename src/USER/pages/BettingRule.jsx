            ...
            <main style={{ marginBottom: "50px" }}>
                    ...
                    <div className="container">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">{t("Betting Rule")}</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div className="container">
                    <div className="ab_title mb-5">
                        <h2 className="title_about text-center">{t("Betting Rule")}</h2>
                    </div>
                    <div className="row mt-5 mb-5">
                        <div className="col-md-6">
                            <div className="heading">
                                <h4>{t("Betting Rule")}</h4>
                                <p>
                        ...
                        <div className="col-md-6">
                            <img
                                src="https://cdn.sportsbettingdime.com/app/uploads/media/2/sports-betting-dummy-featured.jpg"
