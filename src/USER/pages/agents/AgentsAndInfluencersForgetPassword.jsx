...
import { clearVerifyOtp, fetchForgetPassOTP, setNewPasswordAgentInfluencers, storePhoneNumber, verifyOTP } from '../../services/slice/AuthSlice'
...
const AgentsAndInfluencersForgetPassword = () => {
    ...
    const sendOtp = () => {
        if (isNaN(formValues?.contact)) {
            const data = { user_id: formValues.contact, user_id_type: "email", user_type: "Agent" }
            dispatch(fetchForgetPassOTP(data))
        } else {
            const data = { user_id: "+" + phone, user_id_type: "phone", user_type: "Agent" }
    ...
    const onSubmit = () => {
        if (password.newpassword !== password.confirmPassword) {
            ...
            if (isNaN(formValues?.contact)) {
                ...
                dispatch(setNewPasswordAgentInfluencers({ data, navigate, toast }))
...
export default AgentsAndInfluencersForgetPassword